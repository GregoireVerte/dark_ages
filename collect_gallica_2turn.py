...
KEYWORDS = [
    ...
    "justinien",
    "reconquête justinienne",
    "empire byzantin",
    "empire romain d'Orient",
    "peste de justinien",
    "strategikon de Maurice",
    "loi salique",
    "code théodosien",
    "grégoire de tours",
    "isidore de séville",
    ...
    "abdérame",             ## XIX-wieczna pisownia Abd ar-Rahmana
    "invasions sarrasines",
    "sarcophage mérovingien",
    "sarcophage paléochrétien",  ## dla okresu 400-600
    "sarcophage de plâtre",      ## specyfika paryska (tanie sarkofagi gipsowe)
    "auges funéraires",
